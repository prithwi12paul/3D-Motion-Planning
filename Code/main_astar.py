...
def runtest(mapfile, start, goal, verbose = True):
  ...
  # path = Planner.MyPlanner.plan(np.array(start), boundary, blocks, np.array(goal), epsilon = 1)

                            ######  AStar ######
  offset = 0.5
  boundary = boundary[0]
  path = AStar.plan(start_coord = np.array(start), boundary = boundary, blocks = blocks, goal_coord= np.array(goal), epsilon = 1, offset = offset)
  path = np.array(path)
  toc(t0,"Planning")
...
def test_single_cube(verbose = True):
  ...
  success, pathlength = runtest('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\\starter_code\\maps\\single_cube.txt', start, goal, verbose)
...
def test_maze(verbose = True):
  ...
  success, pathlength = runtest('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\\starter_code\\maps\\maze.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_window(verbose = True):
  ...
  success, pathlength = runtest('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\starter_code\maps\window.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_tower(verbose = True):
  ...
  success, pathlength = runtest('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\\starter_code\\maps\\tower.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_flappy_bird(verbose = True):
  ...
  success, pathlength = runtest('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\\starter_code\\maps\\flappy_bird.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength) 
  print('\n')
...
def test_room(verbose = True):
  ...
  success, pathlength = runtest('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\\starter_code\\maps\\room.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_monza(verbose = True):
  ...
  # start = np.array([4.300000000000002, 19.99999999999996, 4.9])
  goal = np.array([3.8, 1.0, 0.1])
  # goal =  np.array([4.300000000000002, 10, 4.9])
  success, pathlength = runtest('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\\starter_code\\maps\\monza.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
if __name__=="__main__":
  ...
  ### CHOOSE THE ENVIRONMENT FROM HERE ###
  ...
  # test_tower()
  test_room()
  # boundary,blocks = load_map('C:\\Users\\ASUS\\Downloads\\ECE276B_PR2\\ECE276B_PR2\\starter_code\\maps\\maze.txt')
  # print(boundary)
  # print(blocks)
